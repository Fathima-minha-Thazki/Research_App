    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#eaeff1' }}>
      ...
      <Container component="main" sx={{ mt: 4, mb: 4 }}>
        <Typography variant="h4" gutterBottom>
          {harvest.productName} Details
        </Typography>
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6}>
            <Card sx={cardStyles}>
              <CardContent>
                <Typography variant="h6">Transport ID</Typography>
                <Typography>{harvest.sellerId}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
          ...
          <Grid item xs={12} sm={6}>
            <Card sx={cardStyles}>
              <CardContent>
                ...
                <Typography>{harvest.productName}</Typography>
              </CardContent>
            </Card>
          </Grid>
          {/* <Grid item xs={12} sm={6}>
          ...
          <Grid item xs={12} sm={6}>
            <Card sx={cardStyles}>
              <CardContent>
                ...
                <Typography>{new Date(harvest.date).toLocaleDateString()}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Card sx={cardStyles}>
              <CardContent>
                ...
                <Typography>{harvest.time}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={6}>
          ...
          <Grid item xs={12}>
            <Card sx={cardStyles}>
              <CardContent>
                ...
                <Typography>{harvest.temperature}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12}>
            <Card sx={cardStyles}>
              <CardContent>
                ...
                <Typography>{harvest.humidity}</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12}>
...
export default TransportProductView;
