...
const SupplierHome = () => {
  ...
  const fetchHarvests = async () => {
    try {
      const response = await axios.get('http://localhost:5000/h/supplierdata');
    ...
    { field: 'Date', headerName: 'Date', width: 150 },
    {
      ...
      renderCell: (params) => (
        <Button
          variant="contained"
          color="primary"
          onClick={() => navigate(`/Supplier-product-view/${harvests[params.id-1]._id}`)}
        >
          View
        </Button>
      ),
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextField
                ...
                placeholder="Enter your unique Supplier ID"
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
