...
module.exports.getTransportData = async (req, res) => {
  try {
    const harvests = await Harvest.find({ transportId: { $ne: null } 
    });
    res.status(200).json(harvests);
  } catch (error) {
    res.status(500).json({ message: error.message });
...
module.exports.getSellerData = async (req, res) => {
  try {
    const harvests = await Harvest.find({ sellerId: { $ne: null } 
    });
    res.status(200).json(harvests);
  } catch (error) {
    res.status(500).json({ message: error.message });
...
module.exports.getFarmerData = async (req, res) => {
  try {
    const harvests = await Harvest.find({ farmerId: { $ne: null } 
    });
    res.status(200).json(harvests);
  } catch (error) {
    res.status(500).json({ message: error.message });
...
module.exports.getSupplierData = async (req, res) => {
  try {
    const harvests = await Harvest.find({ supplierId: { $ne: null } 
    });
    res.status(200).json(harvests);
  } catch (error) {
    res.status(500).json({ message: error.message });
